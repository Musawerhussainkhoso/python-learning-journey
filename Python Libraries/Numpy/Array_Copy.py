...
# Step 3: Update the original stock array
stock[0] = 100
stock[-1] = 70
...
print("Are both arrays equal?", np.array_equal(stock, stock_backup))

# Step 6: Check whether the backup has a parent array
print("stock_backup.base:", stock_backup.base)
